                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li>
                            <a href="#" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi-house"></i>
                                <a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">Normas</a>
                        </li>
                        <li>
                            <a href="#" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi-house"></i>
                                <a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">Galería</a>
                        </li>
                        <li>
                            <a href="#" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi-house"></i>
                                <a class="link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0 link-underline-opacity-75-hover">Servicios</a>
                        </li>
                        <li>
                            <a href="#" class="nav-link px-0 align-middle">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 border-right">
                            <div class="p-3 py-5">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12"><label class="language-">Descripción</label><textarea class="form-control"></textarea></div>
                                </div>
                                <div class="row mt-3">
