<nav id="header" class="color-header navbar navbar-expand navbar-dark" >
    <div class="container-fluid" >
        <a class="navbar-brand" id="headerNom" href="{{ route('principal', ['id' => $PROPIETAT_ID]) }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-house-door-fill mb-2 me-1" viewBox="0 0 16 16">
