...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://www.househostpromp.me/build/assets/custom.css">
    <script src="http://www.househostpromp.me/build/assets/custom2.js"></script>
...
<div>
    <nav class="navbar navbar-expand navbar-dark bg-primary sticky-top" >
        <div class="container-fluid" >
            <a class="navbar-brand" href="{{ route('principal', ['id' => request() -> route('id')])}}">
